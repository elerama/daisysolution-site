  ...
  return (
    <>
      ...
      <Container id="upset-case" className="py-24">
        ...
        <div className="rounded-2xl bg-slate-50 p-8 shadow-lg ring-1 ring-gray-200 lg:p-12 relative overflow-hidden before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_100%_0%,rgba(0,129,190,0.08)_0%,transparent_50%)]">
          <div className="grid gap-8 lg:grid-cols-2">
            {/* Left Column */}
            <div>
              <div className="mb-6 flex items-center gap-4">
                <div className="text-[#0081BE]">
                  <Icon name="lightbulb" className="size-16" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Upset Design</h3>
                  <p className="text-[#0081BE] font-semibold">Settore Illuminazione Specializzata</p>
                </div>
              </div>
      ...
      <div className="bg-slate-50 py-24 relative before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_at_top,rgba(0,129,190,0.06)_0%,transparent_50%)]">
        <Container>
          <div className="mb-16 max-w-2xl">
...
function SectorCard({
  ...
  return (
    <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
      <div className="mb-4 text-[#0081BE]">
