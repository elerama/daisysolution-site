...
export const modules: Record<string, ModuleData> = {
    ...
    'vendite-cassa': {
        ...
        tier: 1,
        overview: {
            intro: 'Il modulo Vendite & Cassa è il cuore operativo di Daisy Solution. Gestisce l\'intero ciclo di vendita: preventivi, ordini clienti, documenti di trasporto, fatture immediate e differite, scontrini fiscali con POS integrato. Sistema di fidelity card e modalità offline per garantire continuità operativa anche senza connessione Internet.',
            mainBenefits: [
                'Ciclo vendita completo integrato',
                'Modalità offline: vendi sempre, anche senza Internet',
                'Fidelizzazione clienti con punti fedeltà',
                'Report vendite real-time per articolo/cliente/operatore'
            ],
            stats: [
                { label: 'Affiliati Unieuro', value: '270', description: 'gestiscono 900 postazioni vendita' },
                { label: 'Modalità offline', value: '100%', description: 'operativo anche senza Internet' }
            ]
        },
        features: [
            { title: 'Preventivi veloci', description: 'Crea preventivi professionali e convertili in ordini con un click', icon: '📋' },
            { title: 'Ordini clienti', description: 'Gestisci ordini B2B e B2C con tracking completo evasione', icon: '📦' },
            { title: 'DDT e fatture', description: 'Emetti documenti di trasporto e fatture immediate o differite', icon: '📄' },
            { title: 'Scontrini POS', description: 'Registratore di cassa fiscale integrato con chiusura giornaliera', icon: '🧾' },
            { title: 'Modalità offline', description: 'Vendi sempre, anche senza connessione Internet', icon: '🔌' },
            { title: 'Fidelity card', description: 'Sistema punti fedeltà per premiare clienti abituali', icon: '🎯' },
            { title: 'Pagamenti multipli', description: 'Contante, carta, bonifico, finanziamento in un solo ordine', icon: '💳' },
            { title: 'Buoni e gift card', description: 'Gestione buoni spesa e gift card ricaricabili', icon: '🎁' }
        ],
        benefits: [
